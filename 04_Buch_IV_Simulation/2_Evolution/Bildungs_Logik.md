...
- **Metrik der Ineffizienz:** Lernprozesse werden nicht auf Geschwindigkeit optimiert. Zeitaufwand gilt als Qualitätsmerkmal, um neuronale Plastizit�t und Tiefenverst�ndnis zu f�rdern (�6 Recht auf Weisheit).
...
- **Fehler-Exploration:** Das System f�rdert gezielt das 'Scheitern' in gesch�tzten Räumen (Sandboxing), um innovative Probleml�sungen außerhalb bekannter Pfade zu generieren.
