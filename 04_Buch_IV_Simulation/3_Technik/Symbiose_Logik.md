...
- **Transparenz-Layer (�22):** Jede KI-Entscheidung muss f�r den Anker Recht (KP-10) und die 13. Instanz in einem 'Audit-Friendly'-Format vorliegen.
...
- **Automatisierungs-Limit:** T�tigkeiten, die f�r die menschliche Sinnerfahrung essenziell sind (soziale Pflege, kreative Prozesse), werden nur auf expliziten Wunsch des Clusters automatisiert.
...
- **Resilienz durch Low-Tech-Backup:** Jeder Cluster muss in der Lage sein, die Grundversorgung (�10-�12) f�r 72 Stunden ohne KI-Unterst�tzung aufrechtzuerhalten.
