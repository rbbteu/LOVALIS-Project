...
- **Experten�bersetzung:** Dateneigentum statt Datennutzung. Das Individuum hat das Recht auf das 'Digitale Vergessen'.
...
- **Technische Spezifikation:** Jede KI-gest�tzte Entscheidung muss in nat�rlicher Sprache begr�ndet werden k�nnen. 'Black-Box'-Systeme sind illegal.
- **Experten�bersetzung:** Rechenschaftspflicht des Codes. Die Logik muss f�r den Menschen auditierbar bleiben.
- **Laienverst�ndnis:** Wenn das System 'Nein' sagt, muss es dir genau erkl�ren k�nnen, warum � und zwar so, dass du es verstehst.
...
- **Laienverst�ndnis:** Fehler werden korrigiert und dann vergessen. Du wirst nicht dein Leben lang f�r einen alten Patzer bestraft.
...
- **Laienverst�ndnis:** Die Chefs m�ssen sich an dieselben Regeln halten wie du. Niemand steht �ber dem Gesetz.
...
- **Experten�bersetzung:** 'Voting with feet'. Die Freiheit zu gehen ist das ultimative Korrektiv gegen schlechte Cluster-F�hrung.
...
- **Experten�bersetzung:** Dynamisches Recht. Gesetze, die ihren Zweck (Leidminimierung) nicht erf�llen, m�ssen gel�scht oder angepasst werden.
